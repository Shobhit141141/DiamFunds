...
const ListFund = ({setProgress}) => {
  ...
  return (
    <div className="w-full h-screen bg-[#1D232A] flex justify-center items-center overflow-auto">
      <div className="mx-auto p-4 bg-gray-900 text-white w-[80%] md:w-[50%]">
        <h1 className="text-2xl font-bold mb-4">List a New Fund</h1>
